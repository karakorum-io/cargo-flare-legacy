...
/* * ************************************************************************************************
 * EmailTemplate class																																			*
 * Class for working with email template																													*
 * 																																											*
        ...
        if (count($vehicles) > 0) {
            ...
            foreach ($vehicles as $vehicle) {
                ...
                if ($sendType == self::SEND_TYPE_TEXT) {
                    ...
                    $list_formatted[] = "<tr><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->year}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->make}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->model}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->lot}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->vin}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->plate}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->state}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->color}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-right:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">".(($vehicle->inop)?'Yes':'No')."</td></tr>";
                    $list_price_formatted[] = "<tr><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->year}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->make}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->model}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->lot}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->vin}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->plate}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->state}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->color}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">".(($vehicle->inop)?'Yes':'No')."</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-right:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->getTariff()}/{$vehicle->getDeposit()}</td></tr>";
                }
            }
            ...
            if ($sendType == EmailTemplate::SEND_TYPE_TEXT) {
                ...
                //inline styles for yahoo, gmail
                $params['vehicle_list_format'] = '<table cellspacing="0" cellpadding="5" border="0" class="vehicles-table" style="background-color: #666666;">';
                $params['vehicle_list_format'].= '<tr><th style="border-bottom:#38b 1px solid; border-top:#38b 1px solid; border-left:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Year</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Make</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Model</th><th  style="border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px; border-bottom:#38b 1px solid; ">Lot #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Vin #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Plate #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">State</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Color</th><th style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; border-right:#38b 1px solid;  background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Inop</th></tr>';
                ...
                $params['vehicle_list_price_format'].= '<tr><th  style="border-bottom:#38b 1px solid; border-top:#38b 1px solid; border-left:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Year</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Make</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Model</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Lot #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Vin #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Plate #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">State</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Color</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Inop</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; border-right:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Price/Deposit</th></tr>';
                $params['vehicle_list_price_format'].= implode('', $list_price_formatted) . '</table>';

                $params['vehicle_table'] = '<table cellspacing="0" cellpadding="3" border="0" class="vehicle-table">';
                $params['vehicle_table'].= '<tr><th style="border-bottom:#38b 1px solid; border-top:#38b 1px solid; border-left:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Year</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Make</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Model</th><th  style="border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px; border-bottom:#38b 1px solid; ">Lot #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Vin #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Plate #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">State</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Color</th><th style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; border-right:#38b 1px solid;  background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Inop</th></tr>';
...
public static function getVehiclesTplInvoice($vehicles, $sendType) {
       ...
       $params = array();
        ...
        if (count($vehicles) > 0) {
			...
			{
				 $list_formatted[] = "<tr><td height=\"20\" style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\"></td>&nbsp;<td height=\"20\" style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\"></td><td height=\"20\" style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\"></td><td height=\"20\" style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\"></td><td height=\"20\" style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\"></td><td height=\"20\" style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid;border-right:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\"></td></tr>";
			}
            
                //inline styles for yahoo, gmail

                $params['vehicle_table_invoice'] = '<table cellspacing="0" cellpadding="3" border="0" class="vehicle-table">';

                $params['vehicle_table_invoice'].= '<tr><th style="border-bottom:#38b 1px solid; border-top:#38b 1px solid; border-left:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Year</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Make</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Model</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Vin #</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Color</th><th style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; border-right:#38b 1px solid;  background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Inop</th></tr>';
        ...
        if (count($vehicles) > 0) {
            ...
            foreach ($vehicles as $vehicle) {
                ...
                $deposit += $vehicle->deposit;
                    ...
                    $list_formatted[] = "<tr><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->year}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->make}</td><td style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">{$vehicle->model}</td><td  style=\"border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-right:#38b 1px solid; background-color: #FFFFFF; text-align: left; padding: 3px 5px;\">".(($vehicle->inop)?'Yes':'No')."</td></tr>";
			 ...
			 //inline styles for yahoo, gmail
                ...
                $params['vehicle_table_short'] = '<table cellspacing="0" cellpadding="3" border="0" class="vehicle-table">';

                $params['vehicle_table_short'].= '<tr><th style="border-bottom:#38b 1px solid; border-top:#38b 1px solid; border-left:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Year</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Make</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Model</th><th  style="border-bottom:#38b 1px solid; border-left:#38b 1px solid; border-top:#38b 1px solid; border-right:#38b 1px solid;  background-color: #EEEEEE; font-weight: bold; text-align: center; padding: 3px 20px;">Inop</th></tr>';
...
public static function getLocationTpl($location,$format,$title) {
        $params = array();
		 ...
		 <table width="50%" cellpadding="1" cellpadding="1" border="0"  style="border:#38b 1px solid;  background-color: #f4f4f4;">
		   ...
		   /*
		   <tr> <td width="30%"><strong>Address</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;">'. $location->address1.',&nbsp;&nbsp;'. $location->address2.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>City</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;">'.$location->getFormatted().'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Location Type</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->location_type.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Hours</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->hours.'</td>
		   </tr>';
		   */
		   /*
		    <tr> <td style="line-height:15px;"><strong>Contact Name 1</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;">'. $location->name.'&nbsp;&nbsp;<? if ($location->phone1 <> '') {?><strong>P:</strong>&nbsp;'. $location->phone1.' <? } ?>&nbsp;&nbsp;<? if ($location->phone_cell <> '') {?><strong>M:</strong>&nbsp;'. $location->phone_cell.' <? } ?></td></tr>
		   <tr><td style="line-height:15px;"><strong>Contact Name 2</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;">'. $location->name2.'&nbsp;&nbsp;<? if ($location->phone2 <> '') {?><strong>P:</strong>&nbsp;'. $location->phone2.' <? } ?>&nbsp;&nbsp;<? if ($location->phone_cell2 <> '') {?><strong>M:</strong>&nbsp;'. $location->phone_cell2.' <? } ?></td></tr>
		   */
		  /*
		   $params[$format] .= '<tr> <td style="line-height:15px;"><strong>Company Name</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->company.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Company Phone</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->phone3.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Company Fax</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->fax.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Auction Name</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->auction_name.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Auction Phone</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->phone4.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Auction Fax</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->fax2.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Buyer Number</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->buyer_number.'</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Booking Number</strong></td><td width="4%" align="center"><b>:</b></td><td>'. $location->booking_number.'</td></tr>				   
         </table>  
	';*/
                ...
                switch ($pk) { 
                   ...
                   <tbody><tr>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div style="display:none" id="sign_draw_controls" class="sign-controls">
                                                ...
                                                <div id="paper" style="width: 400px; height: 100px;"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="400" height="100"><desc>Created with Raphaël</desc><defs/><path fill="none" stroke="#000000" style="stroke-linecap: round; stroke-linejoin: round;" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
                            ...
                            <div id="sign_write_controls" class="sign-controls">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody><tr>
                                        ...
                                        <td><input type="text" class="form-box-textfield latin" id="sign_name" maxlength="64" size="50"></td>
                                    ...
                                    <tr>
                                      <td align="center" colspan="2">
                                        <button style="margin: 0 10px;" id="signature-save-text" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text" style="-moz-user-select: none;">Save</span></button>
                    ...
                    case 'entity_ship_via':
                        ...
                        break;
//                    case 'entity_inop':
//                        $params[$pk] = ($entity->vehicles_run == 1) ? "Operable" : "Inoperable";
//                        break;
