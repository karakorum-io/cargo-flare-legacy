...
<img src="http://www.freightdragondb.com/images/esign.png" alt="" width="34px" height="34px" style="padding-top:2px;">
      </td>
	...
	<div class="wrapper">
            ...
            <table width="100%" cellpadding="1" cellspacing="1" id="contentTable"> <!--height="531515"-->
              ...
              <tr>
                <td align="center">@flash_message@</td>
              </tr> 
              
              <tr>
                <td style="font-family: "Raleway", sans-serif;" align="center"><font size="18"><b>Thank you, we have received your status update for <br>this shipment and you are all set!</b></font></td>
              </tr>
              ...
              <tr>
                <td style="border:1px solid #cccccc;font-family: "Raleway", sans-serif;" align="center"> <span style="color:#999;">If you have any questions regarding this shipment please contact <?=$this->company->companyname?> at <?=$this->company->dispatch_phone?> or email mailto:<?=$this->company->dispatch_email?></span></td>
              </tr> 
              <tr>
                <td>&nbsp; </td>
              </tr> 
