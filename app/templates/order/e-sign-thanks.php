    ...
    <body>
        ...
        <div class="row vertical-center">
            <div class="col-12 col-sm-12 text-center middle-div">
                ...
                <p>We have received your signed order form and you are all set!</p>
                <p class="max-para-width">E-Signature has been confirmed on <?php echo date('m-d-Y h:i A',strtotime($this->entity->esigned_date));?> with the IP address: <?php echo $_SERVER['REMOTE_ADDR'];?> </p>
                <p class="max-para-width"><strong>To download your signed document from Transport Masters USA LLC please use the button below.</strong></p>
                <br/>
