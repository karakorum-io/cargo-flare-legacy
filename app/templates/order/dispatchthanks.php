...
<link rel="shortcut icon" href="<?php echo SITE_IN ?>styles/favicon.ico" />
    ...
    <title>Dispatch Thank You</title>
...
<script language="JavaScript">
  ...
  {
    return "Important : Please don't forget to download your signed dispatch sheet.";
  }
</script>
...
<div class="row hf">
	<div class="wrapper">	
	<table width="40%" cellspacing="1" cellpaddong="1">
    <tbody><tr><td valign="middle" align="center">
<img src="https://www.freightdragon.com/images/esign.png" alt="" width="34px" height="34px" style="padding-top:2px;">
      </td>
	...
	<div class="wrapper">
            ...
            <table width="100%" cellpadding="1" cellspacing="1" id="contentTable"> <!--height="531515"-->
              ...
              <tr>
                <!---<td align="center"> <h1 style="font-size:78px;"><b>Thank You</b></h1></td>--->
				<td align="center"> <h1><b>Thank you, we have received your signed dispatch sheet and you are all set! </b></h1></td>
              </tr> 
              
              <tr>
                <td align="center"><h3>To download your dispatch document from <?php print $this->companyname;?> please use the button below.</h3></td>
              </tr>
              
              <tr>
                <td align="center"> <a target="_blank" href="<?php print SITE_IN."external/getdocs.php?id=".$_GET['id'];?><?php //print getLink("application/orders", "getdocs", "id", $_GET['id'])?>"><button id="signature-save-text" style="background-color:#27aae1!important; text-decoration:none;font-family: "Raleway", sans-serif;">CLICK HERE TO DOWNLOAD YOUR SIGNED DOCUMENT</button></a></td>
              </tr>
              <tr>
                <td>&nbsp; </td>
              </tr> 
              ...
              <tr>
                <td align="center"><h3>IMPORTANT : Don't forget to download your signed dispatch sheet.</h3></td>
              </tr>
              <tr>
                <td>&nbsp; </td>
              </tr> 
