...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Cargo Flare | Forget Password</title>
				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="" style="width: 40%;">
							<!--begin::Form-->
							@flash_message@
							<form action="<?=getLink("user", "forgot-password")?>" name="forgot" method="post">
								<!--begin::Title-->
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark text-center font-size-h4 font-size-h1-lg">Forget Password</h3>
								</div>
								<!--begin::Title-->
								<!--begin::Form group-->
								...
								<div class="d-flex justify-content-between mt-n5">
									<div class="form-group" style="margin-top: 0px;">
                                        <a href="<?=getLink("user", "signin")?>" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Already have an account?</a>
									</div>
									<input type="hidden" class="m-input btn-primary btn-block" name="submit">
									<button type="submit" id="submit_button" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Send recovery link</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
