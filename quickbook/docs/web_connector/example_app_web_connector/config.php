...
require_once dirname(__FILE__) . '/../../libs/QuickBooks.php';

//print dirname(__FILE__) . '/../../QuickBooks.php';

// Your .QWC file username/password
$qbwc_user = 'FreightDragon';
$qbwc_pass = 'freightdragon_db';

// * MAKE SURE YOU CHANGE THE DATABASE CONNECTION STRING BELOW TO A VALID MYSQL USERNAME/PASSWORD/HOSTNAME *
$dsn = 'mysql://freightd_dev:8%FV?WiJmG@*.A=3RT@localhost/freightd_dragon_production_db';
