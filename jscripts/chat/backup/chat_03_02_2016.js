	...
	$.ajax({
		...
		success: function(data){
			...
			if(data.sms > 0){
				...
				var smsIcon = "https://freightdragondb.com/images/communicator/sms_sm.png";
				/*for (i in sms_data) {
					doNotification('sms message from '+sms_data[i].from,sms_data[i].message,i,sms_data[i].id,smsIcon,2);
				}*/
			...
			if(data.chat > 0){
				...
				var chatIcon = "https://freightdragondb.com/images/communicator/chat_sm.png";
				for (i in chat_data) {
