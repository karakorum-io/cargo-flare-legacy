...
<div class="row">
    <div class="col-12 col-sm-4" style="border:1px solid #CCC; padding:30px 30px 0px 30px;">
        <form action="<?= getLink("bills", "paid","type","uncleared_check") ?>" id="filter_form" method="post">
...
<div class="row">
    ...
    <div class="col-12 col-sm-6 text-right">
        ...
        &nbsp;&nbsp;
        <button onclick="void_check()" class="btn btn-warning">Void <VoidButton></VoidButton></button>&nbsp;&nbsp;
        <button onclick="clear_bills()" style="background:green;color:#fff;" class="btn btn-default">Clear <UnclearButton></UnclearButton></button>
    </div>
</div>
...
<table id="invoice-data-table" class="table table-bordered table-striped">
    <thead>
        <tr>
            <td>Order ID</td>
            <td>Uploaded On</td>
            ...
            <td>
                ...
                ?>
                <a <?php echo $sorting;?>>Check Number</a>
            </td>
            <td>Term</td>
            <td>Paid On</td>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td  align="right"><?php echo $data['CheckID'];?></td>
                ...
                <td  align="center">
                    <button onclick="trigger_reprint(<?php echo $data['ID']?>)" class="btn btn-primary">
                        Re Print
                    </button>
                </td>
            </tr>
