...
<div class="row">
    <div class="col-12 col-sm-4" style="border:1px solid #CCC; padding:30px 30px 0px 30px;">
        <form action="<?php echo getLink("bills", "paid","type","uncleared_ach") ?>" method="post">
...
<div class="row">
    <div class="col-12 col-sm-6">
        ...
        <?php
            if($_GET['view_type'] == 1){
        ?>
                <a href="<?php echo getLink("bills","paid/type/uncleared_ach");?>">Show Pagination</a><br><br>
        <?php
            } else {
        ?>
                <a href="<?php echo getLink("bills","paid/type/uncleared_ach","view_type/1");?>">Show All</a><br><br>
        <?php
            }
        ?>
    </div>
    <div class="col-12 col-sm-6 text-right">
        ...
        &nbsp;&nbsp;
        <button onclick="clear_bills()" class="btn btn-success">Clear <UnclearButton></UnclearButton></button>
    </div>
</div>
<?php
    if($_GET['view_type'] != 1){
