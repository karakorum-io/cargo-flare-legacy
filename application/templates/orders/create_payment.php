    ...
    function process_payment(id) {
        ...
        $engine.asyncPost(BASE_PATH + "application/ajax/entities.php", {
            ...
            if (response.success) {
                ...
                $("#entity_id_payment").val("");
                $("#entity_id_payment").val(entity_id);
                ...
                $("#payment_dialog").modal();
            } else {
                $engine.notify("Can't load Order data. Try again later, please");
            }
            KTApp.unblockPage();
        });
    }
...
<!--begin::Modal-->
<div class="modal fade" id="payment_dialog" tabindex="-1" role="dialog" aria-labelledby="payment_dialog_model" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="payment_dialog_model">Payment From</h5>
            ...
            <div class="modal-body">
                ...
                <br />
                <input type="hidden" name="entity_id" id="entity_id_payment"/>
                <form action="<?=getLink('orders/payments/id/' . $_GET['id'])?>" method="post" id="internally_form">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="form-table" id="table_internally">
                        ...
                        <tr>
                            ...
                            <td valign="top" rowspan="2" colspan="2"></td>
                        </tr>
                    </table>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="$operations.processPayment()" class="btn btn-sm btn_light_green">Payments</button>
            </div>
        </div>
    </div>
</div>