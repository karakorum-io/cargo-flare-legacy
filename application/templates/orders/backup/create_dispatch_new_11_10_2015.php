...
function checkEditTimeDue()
  {
	...
	{
	  setEditBlock(); 
      //interval_disp = setInterval(function(){checkEditTimeDue()}, 240000);
    ...
    $(document).ready(function(){
        ...
        //interval_disp = setInterval(function(){checkEditTimeDue()}, 240000);
        <?php } else { ?>
        //alert("Blocked by" + blockedMember + ". Blocked time" + blockedTime + ". You have access after 5 minute." );
        //alert("Someone editing this Order right now. You have access only for read.");
		var alertMsg = "<p><center><strong>" + blockedMember + "</strong> is dispatching this order at this moment.</center></p><center><p>please try again later.</p></center>" ;
		...
		title: "<strong>System Alert</strong>",
    ...
    <div>
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table" style="white-space:nowrap;">
			...
			<tr>
				...
				<td>@deliver_state@@deliver_zip@</td><div id="notes_container"></div>
                ...
                <td rowspan="5" valign="top">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <!--tr>
                            ...
                            <td valign="top">@payments_terms@<br/><i>(Will appear on Shipper Invoice &amp; Shipping
                        ...
                        <tr>
                            ...
                            <!--td valign="top">@order_notes_from_shipper@</td-->

                            <td valign="top"><label for="order_notes_from_shipper">Dispatch Instructions:</label></td>



<td><textarea style="width:600px;height:70px" tabindex="215" name="order_notes_from_shipper" cols="6" rows="7" class="form-box-textarea" id="order_notes_from_shipper"></textarea></td>
