...
<table cellspacing="0" cellpadding="0" border="0" class="grid" width="100%">
    ...
    <tr class="grid-head">
        ...
        <td class="grid-head-left"  width="50">
       ...
       <?php 
        ...
        <?php else : ?>
            ...
            <td  width="55"><?= $avail_title; ?><?php //print $this->order->getTitle("avail", $avail_title) ?>
     ...
     <?php } ?>
        ...
        <td class="grid-head-right"  width="95">
...
$totalTariff += $entity['total_tariff'];
	...
	?>
        ...
        <tr id="order_tr_<?= $entity['entityid'] ?>" class="grid-body<?= ($i == 0 ? " first-row" : "") ?>">
           ...
           <td align="center" class="grid-body-left" bgcolor="<?= $bgcolor ?>" width="50">
            ...
            <td valign="top" style="white-space: nowrap;" bgcolor="<?= $bgcolor ?>" width="96">
        ...
        <?php          
          ...
          if($_GET['orders']=="search")
		    {
				...
				?>
           <td valign="top" align="center" bgcolor="<?= $bgcolor ?>"  width="60">
         ...
         <?php }?>   
            ...
            <td class="grid-body-right" bgcolor="<?= $bgcolor ?>" width="95">
