...
<div style="float:right; width:170px;">
  ...
  <?php if($_SESSION['searchShowCount']==0 ){?>
     ...
     <?php }else{?>
       <a href="<?= SITE_IN ?>application/orders/showsearch/id/<?= $entityPrev ?>/type/des"><img src="<?= SITE_IN ?>images/arrow-down.png"   width="40" height="40"/></a>
  ...
  <?php }else{?>
       <a href="<?= SITE_IN ?>application/orders/showsearch/id/<?= $entityNext ?>/type/asc"><img src="<?= SITE_IN ?>images/arrow-up.png"   width="40" height="40"/></a>
     <?php }?>
...
<br/>
<h3>Order #<?= $this->entity->getNumber() ?> Detail</h3>
<table>
	<tr>
			...
			<tr>
				<td style="vertical-align:top;" valign="top" width="50%">
                  <table width="100%" cellpadding="1" cellpadding="1">
                   ...
                   <tr> <td style="line-height:15px;"><strong>Phone</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->phone1; ?></td></tr>
                   <tr> <td style="line-height:15px;"><strong>Mobile</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->mobile; ?></td></tr>
                   <tr> <td style="line-height:15px;"><strong>Fax</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->fax; ?></td>
...
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	...
	<div>
		 <table width="100%" cellpadding="1" cellpadding="1" border="0"  >
		   <tr> <td width="25%"><strong>Address</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->address1; ?>,&nbsp;&nbsp;<?= $origin->address2; ?></td></tr>
		   ...
		   <tr> <td style="line-height:15px;"><strong>Contact 1</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->name; ?>&nbsp;&nbsp;<strong><?= $origin->phone1; ?></strong></td></tr>
		   <tr> <td style="line-height:15px;"><strong>Contact 2</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->name2; ?>&nbsp;&nbsp;<strong><?= $origin->phone2; ?></strong></td></tr>
...
<td width="49%" valign="top" >
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	<p class="block-title">Dropoff Information THIS IS A TEST</p>
	<div>
		 <table width="100%" cellpadding="1" cellpadding="1" border="0"  >
                     <tr><td width="25%"><strong>Address</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->address1; ?>,&nbsp;&nbsp;<?= $destination->address2; ?></td></tr>
                     ...
                     <tr> <td style="line-height:15px;"><strong>Contact 1</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->name; ?>&nbsp;&nbsp;<strong><?= $destination->phone1; ?></strong></td></tr>
                     <tr> <td style="line-height:15px;"><strong>Contact 2</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->name2; ?>&nbsp;&nbsp;<strong><?= $destination->phone2; ?></strong></td></tr>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="vertical-align:top;" valign="top" width="50%">
                        ...
                        <tr><td colspan="3" align="center"><input type="button" name="CarrierUpdate" value="Update"  onclick="updateCarrier('<?= $this->dispatchSheet->id ?>');"/></td></tr>
                        </table>
...
<div style="float:right;"><?= functionButton('Add Note', 'addInternalNote()') ?></div>
 ...
 <div class="quote-info" style="width:94%;float: left; margin-bottom:10px;">
	...
	<div>
		...
		<strong>Dispatched: </strong><?= $this->entity->getDispatched("m/d/y h:i a") ?><br/>
		<?php } ?>
		<?php if (!is_null($this->entity->archived)) { ?>
		<strong>Archived: </strong><?= $this->entity->getArchived("m/d/y h:i a") ?><br/>
		<?php } ?>
	</div>
</div>  
...
<div class="quote-info" style="width:94%;float: left; margin-bottom:10px;">
	...
	<div>
		...
		<img style="vertical-align: middle" src="<?= SITE_IN ?>images/icons/person.png" alt="Tariff by Customer" title="Tariff by Customer" width="16" height="16"/> <strong>Deposit amount: </strong><span class='<?= $Dcolor;?>'><?= $this->entity->getTotalDeposit() ?></span><br />
         ...
         &nbsp;&nbsp;&nbsp;<strong>Payment Method: </strong> <font color="red"><?= $this->entity->getPaymentOption($this->entity->customer_balance_paid_by); ?></font><br />
       
        &nbsp;&nbsp;&nbsp;<strong>Carrier Paid By: </strong> <font color="red"><?= $Balance_Paid_By; ?></font><br />
...
<div class="order-info" style="width:94%;float: left; margin-bottom:10px;">
	<p class="block-title">Dates</p>
	<div>
		<strong>1st Avail. Pickup Date: </strong><?= $this->entity->getFirstAvail("m/d/y") ?><br/>
