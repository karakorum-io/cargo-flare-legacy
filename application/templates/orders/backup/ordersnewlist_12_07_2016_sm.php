...
<?php if($entity['shipperphone2']!=""){?><div class="shipper_number"><a href="javascript:void(0);" onclick="customPhoneSms('<?= $phone2; ?>','<?= $entity['shipperfname'] ?> <?= $entity['shipperlname'] ?>');"><?= formatPhone($entity['shipperphone2']) ?> </a><?= $phone2_ext;?> <?= $areaCodeStr2;?><br/></div><?php }*/ ?>
            ...
            <?php
                                                    ...
                                                    if(in_array($entity['balance_paid_by'], array(12, 13 , 20 , 21,24)))      $Balance_Paid_By = "Broker:".$balance_paid_by_arr[$balance_paid_by_value];
         ...
         <?php  } ?>   
            ...
            <td class="grid-body-right" bgcolor="<?= $bgcolor ?>" width="10%">
                <table cellspacing="0" cellpadding="0" border="0" width="100%" class="tariff-grid">
                    <tr>
                        <td width="10"><span style="font-weight: bold;" class="hint--left hint--rounded hint--bounce" data-hint="Total Cost"><img src="<?= SITE_IN ?>images/icons/dollar.png" 
                                             width="16" height="16"/></span></td>
                        <td style="white-space: nowrap;"><span style="font-weight: bold;" class="hint--right hint--rounded hint--bounce" data-hint="Total Cost"><span class='<?= $Tcolor;
                                                    ?>'><?= ("$ " . number_format((float)$entity['total_tariff'], 2, ".", ",")) ?></span></span></td>
                    </tr>
                    <tr>
                        <td width="10">
                        ...
                        <td style="white-space: nowrap;"><span style="font-weight: bold;" class="hint--right hint--rounded hint--bounce" data-hint="Carrier Fee"><span class='<?= $Ccolor;
                                                    ?>'><?= ("$ " . number_format((float)$entity['total_carrier_pay'], 2, ".", ",")) ?></span></span><br/></td>
                    </tr>
                    <tr>
                        <td width="10"><span style="font-weight: bold;" class="hint--left hint--rounded hint--bounce" data-hint="Broker Fee"><img src="<?= SITE_IN ?>images/icons/person.png" 
                                             width="16" height="16"/></span></td>
                        <td style="white-space: nowrap;"><span style="font-weight: bold;" class="hint--right hint--rounded hint--bounce" data-hint="Broker Fee"><span class='<?= $Dcolor;
                                                    ?>'><?= ("$ " . number_format((float)($entity['total_tariff'] - $entity['total_carrier_pay']), 2, ".", ",")) ?></span></span></td>
                    </tr>
                </table>
            </td>
        </tr>
