    ...
    <table cellspacing="2" cellpadding="0" border="0" width="100%" class="form-table">
        ...
        <tr>
          ...
          <td align="left">
             ...
             <?php print $carrier_address;?> <?php print $carrier_address2;?><br /><?php print $carrier_city;?>, <?php print $carrier_state;?>, <?php echo str_pad($carrier_zip, 5, '0', STR_PAD_LEFT);?>
          </td>      
        </tr>
        <tr>
                        ...
                        <tr>
                            <td style="vertical-align:top;" valign="top" width="60%">
                                <table width="100%" cellpadding="1" cellpadding="1">
                                    ...
                                    <tr><td style="line-height:15px;"><strong>State/Zip</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td>
									<td>
