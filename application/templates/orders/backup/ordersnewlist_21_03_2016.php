    ...
    <tr>
       <td>Check&nbsp;&nbsp;<span class="like-link" onclick="checkAllOrders()">All</span>&nbsp;&nbsp;|&nbsp;&nbsp;<span class="like-link" onclick="uncheckAllOrders()">None</span></td>
        ...
        <?php }elseif ($_GET['orders'] == "") { ?>
            ...
            <td valign="top"><?= functionButton('Post Load', 'postToFB()') ?></td>
...
$totalTariff = 0;
	...
	flush();
        ...
        if (($_GET['orders'] == "search") || ($_GET['orders'] == "issues")){ 
...
$totalTariff += $entity['total_tariff'];
	...
	?>
        ...
        <?php          
			...
			{
		              if($entity['status'] == Entity::STATUS_ARCHIVED){
...
?>
            <td bgcolor="<?= $bgcolor ?>"  width="16%">
                ...
                <?php if($entity['shipperphone1']!=""){?><div class="shipper_number"><a href="javascript:void(0);" onclick="customPhoneSms('<?= $phone1; ?>');"><?= formatPhone($entity['shipperphone1']) ?> </a><?= $phone1_ext;?> <?= $areaCodeStr;?><br/></div><?php }?>
                <?php if($entity['shipperphone2']!=""){?><div class="shipper_number"><a href="javascript:void(0);" onclick="customPhoneSms('<?= $phone2; ?>');"><?= formatPhone($entity['shipperphone2']) ?> </a><?= $phone2_ext;?> <?= $areaCodeStr2;?><br/></div><?php }?>
...
<?php if (($_GET['orders'] == "issues") ||($_GET['orders'] == "search")){ ?>
<table cellspacing="0" cellpadding="0" width="100%" class="control-bar">
 <tr>
