    ...
    <tr class="grid-head">
       ...
       <?php 
        ...
        <?php else : ?>
            ...
            <td  width="6%"><?= $avail_title; ?><?php //print $this->order->getTitle("avail", $avail_title) ?>
            ...
            <td bgcolor="<?= $bgcolor ?>"  width="16%">
                ...
                <?php if($entity['shipperemail']!=""){?>
					<?php if(strlen($entity['shipperemail']) <= 25 ){?>
						<a href="mailto:<?= $entity['shipperemail'] ?>"><div class="shipper_email"><?= $entity['shipperemail'] ?><br/></div></a>
					<?php } else { ?>
					<a href="mailto:<?= $entity['shipperemail'] ?>"><div class="shipper_email" ><?= substr($entity['shipperemail'], 0, 25)  ?><br/></div></a>
					<?php  }?>
				<?php }?>
          ...
          if($_GET['orders']=="search")
		    {
				...
				?>
           <td valign="top" align="center" bgcolor="<?= $bgcolor ?>"  width="6%">
