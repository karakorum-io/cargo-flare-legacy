...
function expiringEditYes()
	{
      ...
      interval = setInterval(function(){checkEditTimeDue()}, (60*10*1000));
...
function checkEditTimeDue()
  {
	...
	redirectUrl = setInterval(function(){tempDisableBeforeUnload = true;window.location.href = "<?= SITE_IN ?>application/orders/show/id/<?php echo $this->entity->id;?>"; }, (60*5*1000));
  }
