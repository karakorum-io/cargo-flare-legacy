        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table" style="white-space:nowrap;">
            <tr>
                <td>
	                <table class="no-padding">
		                <tr>
			                <td><input type="checkbox" id="save_origin" name="save_origin" value="1"/></td>
			                <td style="padding-bottom:5px"><label for="save_shipper">Save</label></td>
		                </tr>
	                </table>
                </td>
				...
				<table width="100%" cellpadding="1" cellspacing="1">
                  <tr>
                     <td><?php if($accessEdit==1){?>
					             <?= functionButton('Select Location', "selectTerminal('origin');") ?>
                                <?php }else{ ?>
                                <?= functionButton('Select Location', "") ?>
                                <?php }?>
                               </td>
                     <td><b>OR</b>&nbsp;&nbsp;&nbsp;
                           <?php if($accessEdit==1){?>
					             <span class="like-link" onclick="setLocationSameAsShipperOrder('origin')">same as shipper</span>
                                <?php }else{ ?>
                                <span class="like-link" >same as shipper</span>
                                <?php }?>
                     &#8203;</td>
                  </tr>
                 </table> </td>
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table" style="white-space:nowrap;">
            <tr>
                <td>
	                <table class="no-padding">
		                <tr>
			                <td><input type="checkbox" id="save_destination" name="save_destination" value="1"/></td>
			                <td style="padding-bottom:5px"><label for="save_shipper">Save</label></td>
		                </tr>
	                </table>
                </td>
				...
				<table width="100%" cellpadding="1" cellspacing="1">
                      <tr>
                         <td><?php if($accessEdit==1){?>
					             <?= functionButton('Select Location', "selectTerminal('destination');") ?>
                                <?php }else{ ?>
                                <?= functionButton('Select Location', "") ?>
                                <?php }?> </td>
                         <td><b>OR</b>&nbsp;&nbsp;&nbsp;
                         <?php if($accessEdit==1){?>
					             <span class="like-link" onclick="setLocationSameAsShipperOrder('destination')">same as shipper</span>
                                <?php }else{ ?>
                                <span class="like-link" >same as shipper</span>
                                <?php }?>
                         &#8203;</td>
            ...
            <tr>
                ...
                <td rowspan="5" valign="top">
                    <table cellspacing="0" cellpadding="0" border="0">
                       <tr>
							<td valign="top">@notes_from_shipper@<br/><i>(it always appear on Dispatch sheet)</i></td>
						</tr>
						<tr>
							<td valign="top">@notes_for_shipper@<br/><div style="float:left;"><div style="float:left;"><i>(Maximum character allowed is <div id="charNum" style="float:right;">60 )</div></i></div></td>
						</tr>
...
<div style="float:right; padding-top:20px;">
    <? if ($this->ask_post_to_cd) { ?>
        <?= postToCDButtons(SITE_IN . "application/orders/show/id/" . $this->entity->id, "Save") ?>
    <? } else { ?>
		    ...
		    <table cellpadding="0" cellspacing="0" border="0">
			    <tr>
				    <td>
					    ...
					    <?= functionButton("Save &amp; Email", "//$('body').nimbleLoader('show');saveAndEmail();"); ?>
				    </td>
