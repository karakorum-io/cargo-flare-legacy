...
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	...
	<div>
		 <table width="100%" cellpadding="1" cellpadding="1" border="0"  >
		   ...
		   <tr> <td style="line-height:15px;"><strong>Contact 1</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->name; ?>&nbsp;&nbsp;<strong><?= $origin->phone1; ?></strong>&nbsp;&nbsp;or&nbsp;&nbsp;<strong><?= $origin->phone_cell; ?></strong></td></tr>
		   <tr> <td style="line-height:15px;"><strong>Contact 2</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->name2; ?>&nbsp;&nbsp;<strong><?= $origin->phone2; ?></strong>&nbsp;&nbsp;or&nbsp;&nbsp;<strong><?= $origin->phone_cell2; ?></strong></td></tr>
		   <tr> <td style="line-height:15px;"><strong>Company Name</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $origin->company; ?>&nbsp;&nbsp;<strong><?= $origin->phone3; ?></strong></td></tr>
		   <tr> <td style="line-height:15px;"><strong>Auction Name</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $origin->auction_name; ?>&nbsp;&nbsp;<strong><?= $origin->phone4; ?></strong></td></tr>
...
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	...
	<div>
		 <table width="100%" cellpadding="1" cellpadding="1" border="0"  >
                     ...
                     <tr> <td style="line-height:15px;"><strong>Contact 1</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->name; ?>&nbsp;&nbsp;<strong><?= $destination->phone1; ?></strong>&nbsp;&nbsp;or&nbsp;&nbsp;<strong><?= $destination->phone_cell; ?></strong></td></tr>
                     <tr> <td style="line-height:15px;"><strong>Contact 2</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->name2; ?>&nbsp;&nbsp;<strong><?= $destination->phone2; ?></strong>&nbsp;&nbsp;or&nbsp;&nbsp;<strong><?= $destination->phone_cell2; ?></strong></td></tr>
                     <tr> <td style="line-height:15px;"><strong>Company Name</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $destination->company; ?>&nbsp;&nbsp;<strong><?= $destination->phone3; ?></strong></td></tr>
                     <tr> <td style="line-height:15px;"><strong>Auction Name</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $destination->auction_name; ?>&nbsp;&nbsp;<strong><?= $destination->phone4; ?></strong></td></tr>
...
?>
 <div class="quote-info" style="width:94%;float: left; margin-bottom:10px;">
	...
	<div>
	<table width="100%" cellpadding="1" cellpadding="1" border="0"  >
                     <tr><td width="32%"><strong>Total amount</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><span class='<?= $Tcolor;?>'><?= $this->entity->getTotalTariff() ?></span></td></tr>
