...
?>
            <td bgcolor="<?= $bgcolor ?>"  width="16%">
                ...
                <?php if($entity['shipperphone1']!=""){?><div class="shipper_number"><a href="javascript:void(0);" onclick="customPhoneSms('<?= $phone1; ?>');"><?= formatPhone($entity['shipperphone1']) ?> <?= $areaCodeStr;?></a><br/></div><?php }?>
                <?php if($entity['shipperphone2']!=""){?><div class="shipper_number"><a href="javascript:void(0);" onclick="customPhoneSms('<?= $phone2; ?>');"><?= formatPhone($entity['shipperphone2']) ?> <?= $areaCodeStr2;?></a><br/></div><?php }?>
