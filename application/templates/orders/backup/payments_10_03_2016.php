		 ...
		 <table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="vertical-align:top;" valign="top" width="60%">
				   ...
				   <tr><td width="20%" style="line-height:15px;"><strong>Name</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $shipper->fname ?> <?= $shipper->lname ?></td></tr>
                   <tr> <td style="line-height:15px;"><strong>Company</strong></td><td width="4%" align="center"><b>:</b></td><td><strong><?= $shipper->company; ?></strong></td></tr>
			...
			<tr>
				<td style="vertical-align:top;" valign="top" width="60%">
                   <table width="100%" cellpadding="1" cellpadding="1">
                            ...
                            <tr><td width="30%"><strong>Company Name</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?= $this->dispatchSheet->carrier_company_name ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Contact Name</strong></td><td width="4%" align="center" ><b>:</b></td><td><?= $this->dispatchSheet->carrier_contact_name ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Phone 1</strong></td><td width="4%" align="center"><b>:</b></td><td><?= formatPhone($this->dispatchSheet->carrier_phone_1); ?><?= $phone1_ext ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Phone 2</strong></td><td width="4%" align="center"><b>:</b></td><td><?= formatPhone($this->dispatchSheet->carrier_phone_2); ?><?= $phone2_ext ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Fax</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $this->dispatchSheet->carrier_fax ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Email</strong></td><td width="4%" align="center"><b>:</b></td><td><a href="mailto:<?= $this->dispatchSheet->carrier_email ?>"><?= $this->dispatchSheet->carrier_email ?></a></td></tr>
