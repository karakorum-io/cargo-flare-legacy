        ...
        <?php          
			...
			if(trim($entity['shipperphone1'])!="" || trim($entity['shipperphone2'])!="")
			{
				...
				if (!empty($areaCodeRows)) {
					 $areaCodeStr = $areaCodeRows['statecode']."-".$areaCodeRows['StdTimeZone']; 
				}
			}
			?>
