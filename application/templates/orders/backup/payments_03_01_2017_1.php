...
$check_number='';
/*
$inp = $this->daffny->DB->selectRow("id,value", "app_global_config", "WHERE name='check' and status=0");
if (!empty($inp)) {
	$check_number = $inp['value'];
	
	//$check_number++;
	//$this->daffny->DB->update("app_global_config", array('value'=>$check_number), "id = '" . $inp["id"] . "' ");
}*/
?>
<div id="printCheckdiv" style="width:100%;">

    <table cellspacing="2" cellpadding="0" border="0" width="100%" class="form-table">

        <tr>
          <td align="left" width="25%"><b>Carrier Name: </b></td>
          <td align="left">
             <!--input type="left" maxlength="50"  class="elementname form-box-textfield" name="carrier_name" value="<?php //print $carrier_company_name;?>" id="carrier_name"  readonly="readonly" disabled="disabled"/-->
             <?php print $carrier_company_name;?>
          </td>      
        </tr>
        ...
        <tr>
          ...
          <td align="left">
             <!--input type="left" maxlength="250"  class="elementname form-box-textfield" name="carrier_address" value="<?php print $carrier_address;?>" id="carrier_address" readonly="readonly" disabled="disabled"/-->
             <?php print $carrier_address;?> <?php print $carrier_address2;?><br /><?php print $carrier_city;?>, <?php print $carrier_state;?>, <?php print $carrier_zip;?> 
          </td>      
        </tr>
        <tr>
          <td align="left" width="25%"><b>Amount: </b></td>
          <td align="left">
             <!--input type="left" maxlength="12"  class="decimal form-box-textfield" name="carrier_amount" value="<?php print $this->entity->getCarrierPay();?>" id="carrier_amount" readonly="readonly" disabled="disabled"/-->
             <?php print $this->entity->getCarrierPay();?>
          </td>      
        </tr>
        <tr>
          <td align="left" width="25%"><b>Check#: </b></td>
          <td align="left">
             <input type="left" maxlength="15" style="font-size: 2.0em;font-weight: bold;" class="elementname form-box-textfield" name="carrier_check_number" value="<?php print $check_number;?>" id="carrier_check_number" />
          </td>      
        </tr>
    ...
    function createPayment() {
		...
		$.ajax({
			...
			success: function(res) {
				if (res.success) {
					if(res.msg =='')
					 alert('Create Payment Request Success.');
					else
					  alert(res.msg);
				} else {
					alert('Create Payment Request Failed.');
				}
			},
			failed: function(res) {
				alert('Create Payment Request Failed.');
...
function createInvoice() {
		...
		$.ajax({
			...
			success: function(res) {
				if (res.success) {
					if(res.msg =='')
					 alert('Sync Invoice Request Success.');
					else
					  alert(res.msg);
				} else {
					alert('Sync Invoice Request Failed.');
				}
			},
			failed: function(res) {
				alert('Sync Invoice Request Failed.');
	...
	function fixCreateInvoice() {
		...
		$.ajax({
			...
			success: function(res) {
				if (res.success) {
					if(res.msg =='')
					 alert('Fix Invoice Request Success.');
					else
					  alert(res.msg);
				} else {
					alert('Fix Invoice Request Failed.');
				}
			},
			failed: function(res) {
				alert('Fix Invoice Request Failed.');
...
$("#printCheckdiv").dialog({
	...
	buttons: {
		...
		"Print": function () {
			...
			var carrier_amount 	    = $("#carrier_amount").val();
			*/
            var carrier_check_number 	= $("#carrier_check_number").val();
			
			/*
			if(carrier_name =='')
			  alert('Please fill Carrier name.');
			else if(carrier_amount<=0)
			   ...
			   //alert('Check edited: '+checkNumber);
			       //$('body').nimbleLoader('show');
					$.ajax({
						...
						success: function(res) {
							if (res.success) {
								window.open("<?php print SITE_IN;?>external/print_check.php?ent=<?=md5($_GET['id']);?>","","toolbar=yes,scrollbars=yes, resizable=yes,HEIGHT=700,WIDTH=800");
								location.href =  BASE_PATH+"application/orders/payments/id/<?=$_GET['id'];?>";
							} else {
								alert(res.printform);
							}
...
function printCheck(){
	...
	$("#printCheckdiv").dialog("open");
	$("#checkalertdiv").dialog("close");
}

$("#checkalertdiv").dialog({
...
<br />
<div class="order-info" style="width: 850px;float:left;margin-left:10px;">
...
<br>
<br>	
<div class="quote-info" style="width: 280px;float:left;margin-left:10px;">
	<p class="block-title">Payment Terms</p>
	<div>
		<img style="vertical-align: middle" src="<?= SITE_IN ?>images/icons/dollar.png" alt="Total Tariff" title="Total Tariff" width="16" height="16"/> <strong>Total Amount: </strong><span class='<?= $Tcolor;?>'><?= $this->entity->getTotalTariff() ?></span><br />
		<img style="vertical-align: middle" src="<?= SITE_IN ?>images/icons/truck.png" alt="Tariff to Shipper" title="Tariff to Shipper" width="16" height="16"/> <strong>Carrier Fee: </strong><span class='<?= $Ccolor;?>'><?= $this->entity->getCarrierPay() ?></span><br/>
		<img style="vertical-align: middle" src="<?= SITE_IN ?>images/icons/person.png" alt="Tariff by Customer" title="Tariff by Customer" width="16" height="16"/> <strong>Broker Fee: </strong><span class='<?= $Dcolor;?>'><?= $this->entity->getTotalDeposit() ?></span><br />
         <?php 
...
<br>
<br>
<table width="73%" cellpadding="1" cellpadding="1" border="0">
<tr>
...
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	<p class="block-title">Customer Details</p>
	<div>
		 <table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="vertical-align:top;" valign="top" width="60%">
                   <table width="100%" cellpadding="1" cellpadding="1">
				   <tr> <td style="line-height:15px;"><strong>Contact</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->fname ?> <?= $shipper->lname ?></strong></td></tr>
				   <tr> <td style="line-height:15px;"><strong>Company</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->company; ?></td></tr>
				   <tr> <td style="line-height:15px;"><strong>Address</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->address1; ?> <?= $shipper->address2; ?></td></tr>
				   <tr> <td style="line-height:15px;"><strong>City</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->city; ?></td></tr>
				   <tr> <td style="line-height:15px;"><strong>State/Zip</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->state; ?> <?= $shipper->zip_code; ?></td></tr>
...
?> 
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	<p class="block-title">Carrier Details</p>
	<div>
		 <table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="vertical-align:top;" valign="top" width="60%">
                   <table width="100%" cellpadding="1" cellpadding="1">
                            ...
                            <tr><td width="30%"><strong>Contact</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?= $carrier_contact_name ?></td></tr>
							<tr><td style="line-height:15px;"><strong>Company</strong></td><td width="4%" align="center" ><b>:</b></td><td><?= $carrier_company_name?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Address</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?= $carrier_address ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>City</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?= $carrier_city ?></td></tr> 
                            <tr><td style="line-height:15px;"><strong>State/Zip</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?=$carrier_state ?> <?= $carrier_zip ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Phone 1</strong></td><td width="4%" align="center"><b>:</b></td><td><?= formatPhone($carrier_phone_1); ?><?= $phone1_ext ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Phone 2</strong></td><td width="4%" align="center"><b>:</b></td><td><?= formatPhone($carrier_phone_2); ?><?= $phone2_ext ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Fax</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $carrier_fax ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>Email</strong></td><td width="4%" align="center"><b>:</b></td><td><a href="mailto:<?= $carrier_email ?>"><?= $carrier_email ?></a></td></tr>
                            <?php $carrier = $this->entity->getCarrier();?>
                            <?php if ($carrier instanceof Account) { ?>
                            <tr><td style="line-height:15px;"><strong>Hours of Operation</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?= $carrier->hours_of_operation ?></td></tr> 
                            <?php } ?>
                            </table>  
				</td>
				</tr>
...
<?php /*if($_SESSION['parent_id'] ==1){?>
<?= functionButton('Sync Payment', 'createPayment()') ?><?php }*/?>
<br>
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="grid">
    <tr class="grid-head">
    ...
    <?php  foreach ($this->payments as $payment) : ?>
   	<tr class="grid-body" id="row-<?=$payment->id?>">
		...
		<td style="width: 16px;" ><?=deleteIcon(getLink('ajax', 'payments.php?action=delete&id='.$payment->id), "row-".$payment->id)?></td>
        <?php if($payment->fromid== Payment::SBJ_COMPANY && $payment->toid == Payment::SBJ_CARRIER && $_SESSION['parent_id'] ==1){ ?>
           <td style="width: 16px;" class="grid-body-right"><?= functionButton('Sync Vendor Pay', 'createPayment()') ?></td>
        <?php }elseif($payment->fromid== Payment::SBJ_SHIPPER && $payment->toid == Payment::SBJ_COMPANY && $_SESSION['parent_id'] ==1){ ?>
           <td style="width: 16px;" class="grid-body-right"><?= functionButton('Sync Customer Pay', 'syncReceivedPayment(\''.$payment->id.'\')') ?></td>
        <?php }else{?>
...
<div>
<div style="float:left;"><?= functionButton('Create Vendor Bill', 'createBill()') //makeNewWindow?> </div><div style="float:left; margin-left:30px;"><?= functionButton('Fix Vendor Bill Issues', 'createBillWithFix()') //makeNewWindow?>  </div><div style="float:left; margin-left:30px;"><?= functionButton('Sync Customer Invoice', 'createInvoice()') ?></div>
<div style="float:left; margin-left:30px;"><?= functionButton('Fix Customer Invoice', 'fixCreateInvoice()') ?></div>
...
<?php // print functionButton('Print Check', 'printCheckForm(\''.md5($_GET['id']).'\')'); //makeNewWindow?>
<?php print  functionButton('Print Check', 'validatePrintCheck(\''.md5($_GET['id']).'\')'); //makeNewWindow?>
...
<div class="order-info" style="width: 70%;float: left;margin-top: 10px;">
	<p class="block-title">Internal Notes</p>
	<div>
	<?php //if ($this->entity->status != Entity::STATUS_ARCHIVED) : ?>
		<textarea class="form-box-textarea" style="width: 825px; height: 52px;" maxlength="1000" id="internal_note"></textarea>
