           ...
           <td colspan="2" style="padding-left:7px;">
             ...
             <tbody id="skill_id">
               <tr>
                <td>@mail_to_new@</td>
                <td >
                              <div style="float:left;"><ul class="ul-tags"><li><a href="javascript:void(0);" style="font-size:12px; font-family:Verdana, Geneva, sans-serif; font-weight:bold; color:#000;" onclick="AddEmailExtra();"><b><strong>Add More</strong></b></a></li></ul></div>
                </td>
               </tr>
...
<?php
			...
			if(trim($shipper->phone1)!="")
			{
				...
				if (!empty($areaCodeRows)) {
					 $areaCodeStr1 = "".$areaCodeRows['StdTimeZone']."-".$areaCodeRows['statecode'].""; 
				}
			}	
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="vertical-align:top;" valign="top" width="50%">
                   ...
                   <tr><td width="28%"><strong><u>Shipper Information</u></strong></td></tr>
                   ...
                   <tr> <td style="line-height:15px;"><strong>Phone 1</strong></td><td width="4%" align="center"><b>:</b></td><td><a href="javascript:void(0);" onclick="customPhoneSms('<?= $phone1; ?>');"><?= $shipper->phone1; ?> </a><?= $areaCodeStr1; ?></td></tr>
				   <tr> <td style="line-height:15px;"><strong>Phone 2</strong></td><td width="4%" align="center"><b>:</b></td><td><a href="javascript:void(0);" onclick="customPhoneSms('<?= $phone2; ?>');"><?= $shipper->phone2; ?> </a><?= $areaCodeStr2; ?></td></tr>
                   <tr> <td style="line-height:15px;"><strong>Mobile</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->mobile; ?></td></tr>
                   <tr> <td style="line-height:15px;"><strong>Fax</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->fax; ?></td></tr>
                   </table>   
				</td>
				<td style="vertical-align:top;"> 
                   ...
                   <tr><td style="line-height:15px;"><strong>Source</strong></td><td width="4%" align="center"><b>:</b></td><td><?php if($entity['referred_by'] != ""){?><?= $entity['referred_by'] ?><?php }else{?><?php print $entity['source_name']; ?><?php }?></td></tr>
                    <?php endif; ?>
                   </table> 					
				</td>
			</tr>
...
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	...
	<div>
		 <table width="100%" cellpadding="1" cellpadding="1" border="0"  >
		   ...
		   <tr><td>&nbsp;</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Contact Name 1</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->name; ?>&nbsp;&nbsp;<? if ($origin->phone1 <> '') {?><strong>P:</strong>&nbsp;<?= $origin->phone1; ?> <? } ?>&nbsp;&nbsp;<? if ($origin->phone_cell <> '') {?><strong>M:</strong>&nbsp;<?= $origin->phone_cell; ?> <? } ?></td></tr>
		   <tr><td style="line-height:15px;"><strong>Contact Name 2</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->name2; ?>&nbsp;&nbsp;<? if ($origin->phone2 <> '') {?><strong>P:</strong>&nbsp;<?= $origin->phone2; ?> <? } ?>&nbsp;&nbsp;<? if ($origin->phone_cell2 <> '') {?><strong>M:</strong>&nbsp;<?= $origin->phone_cell2; ?> <? } ?></td></tr>
...
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	...
	<div>
		 <table width="100%" cellpadding="1" cellpadding="1" border="0"  >
		   ...
		   <tr><td>&nbsp;</td></tr>
		   <tr> <td style="line-height:15px;"><strong>Contact Name 1</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->name; ?>&nbsp;&nbsp;<? if ($destination->phone1 <> '') {?><strong>P:</strong>&nbsp;<?= $destination->phone1; ?> <? } ?>&nbsp;&nbsp;<? if ($destination->phone_cell <> '') {?><strong>M:</strong>&nbsp;<?= $destination->phone_cell; ?> <? } ?></td></tr>
		   <tr><td style="line-height:15px;"><strong>Contact Name 2</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->name2; ?>&nbsp;&nbsp;<? if ($destination->phone2 <> '') {?><strong>P:</strong>&nbsp;<?= $destination->phone2; ?> <? } ?>&nbsp;&nbsp;<? if ($destination->phone_cell2 <> '') {?><strong>M:</strong>&nbsp;<?= $destination->phone_cell2; ?> <? } ?></td></tr>
