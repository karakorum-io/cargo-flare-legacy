...
<div id="printCheckdiv" style="width:100%;">
    ...
    <table cellspacing="2" cellpadding="0" border="0" width="100%" class="form-table">
        ...
        <tr>
          ...
          <td align="center">
             <input type="left" maxlength="50"  class="elementname form-box-textfield" name="carrier_check_number" value="<?php print $check_number;?>" id="carrier_check_number" />
          </td>      
        </tr>
...
$carrier_fax          = $this->dispatchSheet->carrier_fax;
$carrier_email          = $this->dispatchSheet->carrier_email;
$c_address1         = $this->dispatchSheet->c_address1;
$c_address2       = $this->dispatchSheet->c_address2;
$c_state          = $this->dispatchSheet->c_state;
$c_city          = $this->dispatchSheet->c_city;
$c_zip_code          = $this->dispatchSheet->c_zip_code;
			...
			<tr>
				<td style="vertical-align:top;" valign="top" width="60%">
                   <table width="100%" cellpadding="1" cellpadding="1">
                            ...
                            <tr><td style="line-height:15px;"><strong>Address</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?= $c_address1 ?> <?= $c_address2 ?></td></tr>
                            <tr><td style="line-height:15px;"><strong>City</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?= $c_city ?></td></tr> 
                            <tr><td style="line-height:15px;"><strong>State/Zip</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td><?=$c_state ?> <?= $c_zip_code ?></td></tr>
