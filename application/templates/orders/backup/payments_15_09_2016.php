...
<div style="float:left;"><div style="float:left;"><?= functionButton('Create Bill', 'createBill()') //makeNewWindow?> </div><div style="float:left; margin-left:30px;"><?= functionButton('Fix Create Bill Issues', 'createBillWithFix()') //makeNewWindow?></div>
<?php }?>
<br>
<!---<table cellpadding="0" cellspacing="0" border="0" width="82%" class="grid">
    <tr class="grid-head">
