...
<div id="printCheckdiv" style="width:100%;">
    ...
    <table cellspacing="2" cellpadding="0" border="0" width="100%" class="form-table">
        ...
        <tr>
          ...
          <td align="center">
             <input type="left" maxlength="50"  class="elementname form-box-textfield" name="carrier_name" value="<?php print $carrier_contact_name;?>" id="carrier_name"  readonly="readonly" disabled="disabled"/>
          </td>      
        </tr>
        ...
        <tr>
          ...
          <td align="center">
             <input type="left" maxlength="250"  class="elementname form-box-textfield" name="carrier_address" value="<?php print $carrier_contact_name;?>" id="carrier_address" readonly="readonly" disabled="disabled"/>
          </td>      
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="center">
             <input type="left" maxlength="50"  class="elementname form-box-textfield" name="carrier_check_number" value="" id="carrier_check_number" />
          </td>      
        </tr>
