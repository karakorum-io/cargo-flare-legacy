                ...
                <td>@carrier_phone1@@carrier_phone1_ext@</td>
                 <td rowspan="4" colspan="2"  valign="top">
                     <table width="100%" cellpadding="0" cellspacing="0">
                       ...
                       <tr><td colspan="2"  valign="top" style="border-bottom:1px solid #CCC;">
...
<td><textarea style="width:580px;height:70px" tabindex="215" name="order_notes_from_shipper" cols="6" rows="7" class="form-box-textarea" id="order_notes_from_shipper"></textarea></td>
                        ...
                        <tr>
                            ...
                            <td><input type="hidden" name="order_include_shipper_comment" id="order_include_shipper_comment" value="1" /-->
...
<td style="padding-left: 15px;"><?php print postToDispatchButtons(SITE_IN . "application/orders/show/id/" . $this->entity->id, "Dispatch"); ?></td>
<?php } else{?>
				    <td style="padding-left: 15px;"><?php print submitButtons(SITE_IN."application/orders/show/id/", "Dispatch") ?></td>
                     <?php }*/?>
					 
					 <td style="padding-left: 15px;"><?php //print postToDispatchButtons(SITE_IN . "application/orders/show/id/" . $this->entity->id, "Dispatch"); ?><?php print submitButtons(SITE_IN."application/orders/show/id/", "Dispatch"); ?></td>
