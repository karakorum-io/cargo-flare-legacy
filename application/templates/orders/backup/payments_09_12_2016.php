...
<div>
<div style="float:left;"><?= functionButton('Create Bill', 'createBill()') //makeNewWindow?> </div><div style="float:left; margin-left:30px;"><?= functionButton('Fix Create Bill Issues', 'createBillWithFix()') //makeNewWindow?>
</div>
</div>
<br />
<br>
