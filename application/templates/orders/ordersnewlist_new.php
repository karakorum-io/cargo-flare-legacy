                    ...
                    <?php foreach($this->company_members as $member) : ?>
                       ...
                       <!-- <option value="<?//= $member->id ?>"><?//= $member->contactname ?></option>  -->
						<?php if($member->status == "Active"){
							$activemember .="<option value=""><?php print "Select One"; ?></option><option value= '".$member->id."'";
						?>
								                              
               <?php
                 if (isset($_SESSION['view_id'])) {
                    if ($_SESSION['view_id'] == $member->id)
                         $activemember .= ' selected="selected" ';
                        }elseif ($_SESSION['view_id']!="" && $_SESSION['member_id'] == $member->id) {
                                        
                        $activemember .= ' selected="selected" ';
					}
                    ?>
                <?php $activemember .=">" .$member->contactname ."</option>"; ?>
...
<tr>
                        ...
                        <td style="white-space: nowrap;" width="90"  bgcolor="#FFFFFF"><span ><b><?php //print ("$ " . number_format((float)$this->sumAmount[0]['total_tariff_stored'], 2, ".", ",")) ?></b></span></td-->
