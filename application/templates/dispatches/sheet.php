<table cellpadding="0" cellspacing="0" border="0" class="dispatch_table" width="100%">
<tr>
	<td class="group" width="50%">
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<td class="c_companyname"><span style="font-size: 20px;">@c_companyname@</span></td>
			</tr>
			<tr>
...
<tr>
	...
	<td class="group">
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<td>Phone (1):</td>
				<td class="carrier_phone_1">@carrier_phone_1@</td>
			</tr>
			<tr>
				<td>Phone (2):</td>
				<td class="carrier_phone_2">@carrier_phone_2@</td>
			</tr>
			<tr>
				<td>Phone (Fax):</td>
	...
	<td class="group">
		<table cellpadding="0" cellspacing="0" border="0">
            ...
            <!--tr>
                ...
                <td class="entity_booking_number">@entity_booking_number@</td>
            </tr>
            <tr>
                <td>Buyer Number:</td>
                <td class="entity_buyer_number">@entity_buyer_number@</td>
            </tr-->
			
			
<!--			<tr>-->
<!--				<td>Vehicles Run:</td>-->
<!--				<td class="vehicles_run">@vehicles_run@</td>-->
<!--			</tr>-->
		</table>
	</td>
	<td class="group">
...
<tr>
	<td class="group">
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<td>Phone (1):</td>
				<td class="from_phone_1">@from_phone_1@</td>
			</tr>
			<tr>
				<td>Phone (2):</td>
				<td class="from_phone_2">@from_phone_2@</td>
			</tr>
			<tr>
				<td>Phone (Cell):</td>
	...
	<td class="group">
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<td>Phone (1):</td>
				<td class="to_phone_1">@to_phone_1@</td>
			</tr>
			<tr>
				<td>Phone (2):</td>
				<td class="to_phone_2">@to_phone_2@</td>
			</tr>
			<tr>
				<td>Phone (Cell):</td>
...
<div class="fake-th">Dispatch Instructions</div>
<div class="fake-td">
    @instructions@
    <br/>
    @information@
...
<div class="fake-th">Additional Terms</div>
