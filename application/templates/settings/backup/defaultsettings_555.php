...
<form action="<?= getLink("defaultsettings") ?>" method="post">
    <div style="float:left; width:480px; padding-right:10px;">
        ...
        <!--
        Modified UI section
        @updates: Added tabs & added UI for TAQ, central dispatch UI under tabs
        @author: Chetu Inc.
        @updateDate: 15032018
        -->
        <script>
        ...
        <div id="tabs-custom" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <div id="tabs-999" class="custom-tabs">
                <br>
                <!--Central Dispatch API Section-->
                <?php echo formBoxStart("CentralDispatch Integration"); ?>
            ...
            <div id="tabs-998" class="custom-tabs">
                <br>
                <!--Auto Quoting API configurations UI-->
                <?php echo formBoxStart("Auto Quoting Configurattions"); ?>
                    <table width="100%" cellspacing="5" cellpadding="5" border="0">  
                        <em>
                            Please enter your <strong>API KEY</strong> and
                            <strong>API PIN</strong> below. Contact your Member 
                            in case you are not holding the required information.
                        </em>
                        <tr>
                        <tr>
                        <tr>
                        <tr><td width="130">@auto_quote_api_pin@</td></tr>
                        <tr><td>@auto_quote_api_key@</td></tr>
                        <tr><td>&nbsp;</td><td align="center">@on_off_auto_quoting@</td></tr>;
                        <tr>
                            <td colspan="2" align="right">
                                <br />
    ...
    <div style="float:left; width:480px;">
        ...
        <table cellspacing="5" cellpadding="5" border="0">
            <tr>
                <td colspan="2" align="left"> 
                    <em>Daily dispatch report daily settings</em>
                </td>
            </tr>  
            <tr>
                <td colspan="2">
                ...
                <td>
                    ...
                    <div>
                        ...
                        <div style="display:none;" id="tab2">                       
                            <div style="text-align: right;padding:10px; font-weight: bold; font-size: 16px;">
