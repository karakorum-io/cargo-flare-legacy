<script type="text/javascript">
	...
	function addVehicleQuick() {
	    ...
	    */		
			var vehicle_row_body = '<tr class="grid-body" rel="'+id+'"><td class="grid-body-left" align="center">'
				+'<input type="text" style="width:90px;" class="form-box-textfield digit-only" id="year" maxlength="4" name="year[]" value="'
				//+$("#vehicle_form input[name='year']").val()
				+'"/></td>'
				+'<td align="center"><input type="text"  style="width:90px;" class="form-box-textfield vehicle-make-'+id+'" id="make" maxlength="32" name="make[]" value="'
				//+$("#vehicle_form input[name='make']").val()
				+'"/></td>'
				+'<td align="center"><input type="text" style="width:90px;"  class="form-box-textfield vehicle-model-'+id+'" id="model" maxlength="32" name="model[]" value="'
				//+$("#vehicle_form input[name='model']").val()
				+'"/></td>'
				+'<td align="center"><input type="text" style="width:90px;"  class="form-box-textfield vehicle-type-'+id+'" id="add_vehicle_type" maxlength="32" name="type[]" value="'
				//+$("#vehicle_form input[name='type']").val()
				+'"/></td>'
				+'<td align="center"><input type="text" style="width:90px;" name="vin[]" class="form-box-textfield alphanum" maxlength="20"   id="add_vehicle_vin" value="'
				//+$("#vehicle_form input[name='vin']").val()
				+'"/></td>'
				+'<td align="center"><input type="text" style="width:90px;" name="lot[]" id="add_vehicle_lot" class="form-box-textfield alphanum" maxlength="20" value="'
				//+$("#vehicle_form input[name='lot']").val()
				+'"/></td>'
				+'<td align="center">'
				+(($("#vehicle_form select[name='inop']").val() == '1')?'Yes':'No')
				+'</td>'
