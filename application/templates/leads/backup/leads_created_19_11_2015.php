...
<table cellspacing="0" cellpadding="0" border="0" class="grid" width="100%">
   ...
   foreach($this->entities as $i => $entity) :
	...
	$urlDetail = "show";
	if($entity['status'] != Entity::STATUS_CACTIVE && $entity['status'] != Entity::STATUS_CASSIGNED){ //&& $this->entity->status != Entity::STATUS_CASSIGNED
	...
	<td>
			...
			<?php 
             ...
             <td style="white-space: nowrap;"  class="grid-body-right">
                <?php if ($this->status == Entity::STATUS_CACTIVE || $this->status == Entity::STATUS_CASSIGNED) { ?>
