   ...
   foreach($this->entities as $i => $entity) :
	...
	<td  width="5%">
	        ...
	        <td  width="19%">
                ...
                <?php if($entity['shipperphone1']!=""){ $phone1 = str_replace($words, $wordsReplace, $entity['shipperphone1']); ?><div class="shipper_number"><a href="javascript:void(0);" onclick="showSMSDialog('<?php print $entity['entityid'];?>','<?= $phone1; ?>','Shipper');"><?= formatPhone($entity['shipperphone1']) ?></a><br/></div><?php }?>
                <?php if($entity['shipperphone2']!=""){  $phone2 = str_replace($words, $wordsReplace, $entity['shipperphone2']);  ?><div class="shipper_number"><a href="javascript:void(0);" onclick="showSMSDialog('<?php print $entity['entityid'];?>','<?= $phone2; ?>','Shipper');"><?= formatPhone($entity['shipperphone2']) ?></a><br/></div><?php }?>
