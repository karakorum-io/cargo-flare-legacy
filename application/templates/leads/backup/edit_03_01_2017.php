			...
			<tr class="grid-body">
				...
				<td class="grid-body-right" style="white-space: nowrap;">
                  ...
                  <?php //if(($note->sender_id == (int)$_SESSION['member_id']) || ((int)$_SESSION['member_id']==1)){
					  //if ($_SESSION['member']['access_notes'] == 2 || $_SESSION['member']['access_notes'] == 3 && $_SESSION['member']['access_lead_sources'] == 0 && $_SESSION['member']['access_users'] == 0){
