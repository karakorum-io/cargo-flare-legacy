...
<?php include('lead_menu.php');  ?></div><br/><h3>Quote #<?= $this->entity->number ?> Detail</h3><div style="clear: both;"></div>
<h1>Current Status:&nbsp;<?php print "<span class='black'>Quotes</span>";?></h1>
<table>
	<tr> 
