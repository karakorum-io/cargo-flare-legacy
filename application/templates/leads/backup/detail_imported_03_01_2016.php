...
<?php include('lead_menu_imported.php');  ?></div><br/><h3>Lead #<?= $this->entity->number ?> Detail</h3><div style="clear: both;"></div>
<table>
	<tr> 
	<td valign="top" width="75%">
<div class="order-info" style="width:97%; margin-bottom: 10px;"> 
<?php	//$source = $this->entity->getSource();	
...
$vehicles = $this->entity->getVehicles();?>	<p class="block-title">Lead Information</p>	<div>				
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="vertical-align:top;" valign="top" width="50%">
                   ...
                   <tr> <td style="line-height:15px;"><strong>Shipper's Phone 1</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->phone1; ?></td></tr>
				   <tr> <td style="line-height:15px;"><strong>Shipper's Phone 2</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $shipper->phone2; ?></td></tr>
...
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	...
	<div>
		 <table width="100%" cellpadding="1" cellpadding="1" border="0" >
		   <tr> <td style="line-height:15px;"  width="20%"><strong>City</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><span class="like-link"onclick="window.open('<?= $origin->getLink() ?>')"><?= $origin->city ?></span></td></tr>
		    <tr> <td style="line-height:15px;"  width="20%"><strong>State</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->state ?></td></tr>
            <tr> <td style="line-height:15px;"  width="20%"><strong>Zip</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $origin->zip ?></td></tr>
         </table>  
	</div>
</div> 
</td> 
...
<div class="order-info"  style="width:95%; margin-bottom: 10px;">
	...
	<div>
		 <table width="100%" cellpadding="1" cellpadding="1" border="0"  >
                     <tr> <td style="line-height:15px;"  width="20%"><strong>City</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><span class="like-link"onclick="window.open('<?= $destination->getLink() ?>')"><?= $destination->city ?></span></td></tr>
                     <tr> <td style="line-height:15px;" width="20%"><strong>State</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->state ?></td></tr>
            <tr> <td style="line-height:15px;"  width="20%"><strong>Zip</strong></td><td width="4%" align="center"  style="line-height:15px;"><b>:</b></td><td align="left"  style="line-height:15px;"><?= $destination->zip ?></td></tr>
		</table>
	</div>
</div> 
	</td>
   ...
   <td valign="top" style="padding-left:5px;"> 
     ...
     <?php if($this->entity->lead_type==1){?>
        ...
        <div class="quote-info" style="width:94%;float: left; margin-bottom:10px;">
            	<p class="block-title">Status<?php print "<span class='black'>: Imported Lead</span>";?></p>
            <div>		<strong>New lead: </strong><?= $this->entity->getReceived("m/d/y h:i a") ?>	</div>
        </div> 
 <div class="quote-info" style="width:94%;float: left; margin-bottom:10px;">
            	<p class="block-title">Dates</p>
            <div>		<strong>Estimated Ship Date: </strong><?= $this->entity->getShipDate("m/d/y") ?>	</div>
        </div> 
