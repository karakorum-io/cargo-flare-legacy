...
<table cellspacing="0" cellpadding="0" border="0" class="grid" width="100%">
    ...
    <tr class="grid-head" >
        ...
        <td class="grid-head-left" width="8%">
        ...
        <td   width="15%">Hours of Operations</td>
        <td width="16%">Shipment Types</td>
        <td width="7%">Units/month</td>
        <td   width="12%"  class="grid-head-right"><?php if (isset($this->order)) { ?>
...
<table cellspacing="0" cellpadding="0" border="0" class="grid" width="100%">
   ...
   foreach($this->entities as $i => $entity) :
	...
	<td align="center" class="grid-body-left" width="8%">
	...
	<td   width="5%">
			...
			<?php 
			   ...
			   elseif($entity['shippershipment_type']==3)
			      $shipment_type = "Both";	
             ?>   
              <td  width="15%"><?= $entity['shipper_hours'] ?></td>
             <td width="16%"><?= $shipment_type ?></td>
             <td width="7%"><?= $entity['shippershipment_type'] ?></td>
               <td  width="12%"><!--img src="<?php //print SITE_IN?>images/icons/hot.png" alt="Deposit" title="Hot Leads" -->
                ...
                <?php }
                  ...
                  <input type="hidden" id="lead_tariff_<?=$entity['entityid']?>" class="form-box-textfield decimal" value="<?=number_format($entity['total_tariff_stored'], 2, ".", "")?>" style="width: 50px;"/>
                    ...
                    <td style="white-space: nowrap;"  class="grid-body-right"  width="7%"><?=$entity['last_activity_date']?></td>
				  <?php 
				  }else { ?>
