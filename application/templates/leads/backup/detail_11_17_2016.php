...
<div class="order-info" style="width:97%; margin-bottom: 10px;"><?php	$source = $this->entity->getSource();	$assigned = $this->entity->getAssigned();	$shipper = $this->entity->getShipper();	$origin = $this->entity->getOrigin();	$destination = $this->entity->getDestination();	$vehicles = $this->entity->getVehicles();?>	<p class="block-title">Lead Information</p>	<div>				
<?php
