...
<div id="acc_search_dialog DDDDD">
...
<tr><td>
<?php if ($this->status != Entity::STATUS_ARCHIVED || $_GET['leads']=="search" || $_GET['etype']==1 || $_GET['etype']==4) { ?>
<table cellspacing="0" cellpadding="0" width="100%" class="control-bar">
	<tr>
       ...
       <?php  if ($this->status != Entity::STATUS_LQUOTED && 
				  ...
				  $this->status != Entity::STATUS_LAPPOINMENT){?>
