...
<?php include('lead_menu.php');  ?></div><br/><h3>Quodte #<?= $this->entity->number ?> Detail</h3><div style="clear: both;"></div>
<h1>Currentd Status:&nbsp;<?php print "<span class='black'>Quotes</span>";?></h1>
<table>
	<tr> 
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="vertical-align:top;" valign="top" width="50%">
                   ...
                   <tr> <td style="line-height:15px;"><strong>Phone 1</strong></td><td width="4%" align="center"><b>:</b></td><td><?= formatPhone($shipper->phone1); ?> <?=$areaCodeStr ?></td></tr>
				   <tr> <td style="line-height:15px;"><strong>Phone 2</strong></td><td width="4%" align="center"><b>:</b></td><td><?= formatPhone($shipper->phone2); ?> <?=$areaCodeStr2 ?></td></tr>
                   <tr> <td style="line-height:15px;"><strong>Mobile</strong></td><td width="4%" align="center"><b>:</b></td><td><?= formatPhone($shipper->mobile); ?> <?=$areaCodeStr3 ?></td></tr>
				...
				<td style="vertical-align:top;"> 
                   ...
                   <tr><td style="line-height:15px;"><strong>Source</strong></td><td width="4%" align="center"><b>:</b></td><td><?= $this->entity->referred_by ;//$sourceName ?></td></tr>
                    <?php endif; ?>
                   </table> 					
				</td>
			</tr>
