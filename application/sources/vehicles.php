...
class ApplicationVehicles extends ApplicationAction
{

    public function idx()
    {
        try {
            $this->tplname = "vehicles.search";
            $this->title = "Search Vehicles";
            $this->section = "Freight Board";
            $this->breadcrumbs = $this->getBreadCrumbs(array(getLink('vehicles') => "Freight Board", '' => 'Search Vehicles'));
