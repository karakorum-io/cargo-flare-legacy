<?php
	...
	*/
	...
	{
		$result = $db->execute("
			SELECT status, popout, hash_id, is_admin, play_sound, window_open, chatroom_block_chats, only_names, unfocus_chat, focus_chat, block_chats, chatroom_sound, guest_name, chatroom_show_names, ip_address, is_mod, session_time, session_start_time, welcome_viewed
